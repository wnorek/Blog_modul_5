...
namespace WebAPI.Controllers.V1
{
    ...
    {
        private readonly IAttachemntService _attachmentService;
        private readonly IPostService _postService;

        public AttachmentsController(IAttachemntService attachmentService, IPostService postService)
        {
        ...
        {
            var pictures = await _attachmentService.GetAttachmentByPostIdAsync(postId);
